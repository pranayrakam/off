...
<form method='post' action="register.php">
  ...
  <div class="container bg">
      <h2><font color='white'>WOMEN HairStyles</font></h2>

      
      <div class="row left1"> 
          <div class="col-md-4">
          <img src="images/w1.jpg" class="img-responsive" />
              <div class="m1">
              <p>Hairstyle name:hey </p>
              <p>Price:</p>
                  <p><a href="appointment.php" class="btn btn-primary">Get an Appointment</a></p>
                  </div>
          </div>
          <div class="col-md-4">
          <img src="images/w2.jpg" class="img-responsive" />
              <div class="left">
           ...
           <div class="col-md-4">
          <img src="images/w3.jpg" class="img-responsive" />
              <div class="left">
              <p>Hairstyle name: </p>
              <p>Price:</p>
                  <p><a href="appointment.php" class="btn btn-primary">Get an Appointment</a></p>
            ...
            <div class="row left1"> 
          <div class="col-md-4">
          <img src="images/w4.jpg" class="img-responsive" />
              <div class="m1">
              <p>Hairstyle name:hey </p>
              <p>Price:</p>
                  <p><a href="appointment.php" class="btn btn-primary">Get an Appointment</a></p>
          ...
          <div class="col-md-4">
          <img src="images/w5.jpg" class="img-responsive" />
              <div class="left">
              <p>Hairstyle name:hello </p>
              <p>Price:</p>
                  <p><a href="appointment.php" class="btn btn-primary">Get an Appointment</a></p>
           ...
           <div class="col-md-4">
          <img src="images/w6.jpg" class="img-responsive" />
              <div class="left">
              <p>Hairstyle name: </p>
              <p>Price:</p>
                  <p><a href="appointment.php" class="btn btn-primary">Get an Appointment</a></p>
