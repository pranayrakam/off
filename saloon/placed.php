...
<center>    <div class='loginform' style='font-size:25px;'>
      Your Slot has been successfully booked.<br>
      Date: <?php echo $_GET['datee'] ?><br>
      Time: <?php echo $_GET['timee'] ?><br>
      Type: <?php echo $_GET['type'] ?><br>
      Be in the saloon by the time.<br>
      Thank you
    </div></center>
