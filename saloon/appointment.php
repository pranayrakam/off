...
<form method='post' action="register.php">
  <div class="container">
    ...
    <select  name='haircut'>
                      ...
                      <option value="Haircut and Massage">Haircut and Massage</option>
...
<br><br>
    ...
    <button type="submit" class="registerbtn" name="appointment" style="border-radius: 10px 10px 10px 10px;">Book</button>
